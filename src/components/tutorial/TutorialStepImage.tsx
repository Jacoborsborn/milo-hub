      ...
      <div className="relative w-full overflow-hidden rounded-xl border bg-muted/30">
        ...
        >
          ...
          <button
            ...
            className="absolute right-3 top-3 inline-flex items-center justify-center rounded-md border bg-background/80 p-2 text-foreground shadow-sm backdrop-blur hover:bg-background"
        ...
        >
          ...
          >
            <button
              type="button"
              onClick={() => setOpen(false)}
              className="absolute right-3 top-3 z-10 inline-flex items-center justify-center rounded-md border bg-background/90 p-2 text-foreground shadow-sm backdrop-blur hover:bg-background"
              aria-label="Close"
              title="Close"
            >
